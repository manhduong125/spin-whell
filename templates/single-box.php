<?php
/**
 * Single template for Spin Box post type (Hộp quà may mắn - Flatsome standalone style)
 *
...
<body <?php body_class( 'spin-box-standalone-page' ); ?>>
...
<div id="wrapper">
    <div id="main" class="<?php echo esc_attr( $main_classes ); ?>">
        ...
        while ( have_posts() ) :
            the_post();
            $box_id = get_the_ID();
            include WP_SPIN_WHEEL_PATH . 'templates/wheel-box.php';
        endwhile;
        ?>
    </div>
</div>
