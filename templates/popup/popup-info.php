...
<div class="position-absolute top-0 start-0">
    <div class="dropdown me-2" style="display: inline-block;">
        <button class="btn dropdown-togglex" style="color:#000000" type="button" data-bs-toggle="dropdown"
            aria-expanded="false">
        ...
        <ul class="dropdown-menu shadow-lg" aria-labelledby="sw-menu-dropdown-btn"
            style="border-radius: 8px; border: none; padding: 6px 0;">
            <li><a class="dropdown-item" href="javascript:void(0);" id="btn-zoomin"><svg
            ...
            <li><a class="dropdown-item d-none" href="javascript:void(0);" id="btn-zoomout"><svg
                        xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none"
                        stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
            ...
            <li><a class="dropdown-item" href="javascript:void(0);" id="menu-btn-info" data-bs-toggle="modal"
                    data-bs-target="#modalInfo" data-toggle="modal" data-target="#modalInfo"><svg
                        xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none"
                        stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
            ...
            <li><a class="dropdown-item" href="javascript:void(0);" id="menu-btn-rs" data-bs-toggle="modal"
                    data-bs-target="#modalRs" data-toggle="modal" data-target="#modalRs"><svg
                        xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none"
                        stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
            ...
            <li><a class="dropdown-item" href="javascript:void(0);" id="menu-btn-displaystats" data-bs-toggle="modal"
                    data-bs-target="#modalDisplaystats" data-toggle="modal" data-target="#modalDisplaystats"><svg
                        xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none"
                        stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
            ...
            <li><a class="dropdown-item btn-create-new-user-wheel-top" href="javascript:void(0);"><svg
                        xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none"
                        stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
            ...
            <li><a class="dropdown-item" href="javascript:void(0);" id="btn-copy-wheel"><svg
                        xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none"
                        stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
            ...
            <li><a class="dropdown-item" href="javascript:void(0);" id="btn-download-code"><svg
                        xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none"
                        stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
        ...
        <div class="modal-content shadow-lg border-0">
            <div class="modal-header bg-light">
                <h5 class="modal-title font-weight-bold" id="modalInfoLabel">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="22" viewBox="0 0 24 24" fill="none"
                        stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                        class="feather feather-alert-circle text-primary me-2">
                        <circle cx="12" cy="12" r="10"></circle>
                        <line x1="12" y1="8" x2="12" y2="12"></line>
                        <line x1="12" y1="16" x2="12.01" y2="16"></line>
                    </svg>
            ...
            <div class="modal-body py-3">
                <div class="card border-0 bg-light p-3 mb-3">
                    <h6 class="text-primary fw-bold mb-3 sw-stat-title"><?php echo esc_html($wheel_stats['title']); ?>
                    </h6>
                    <div class="row g-3">
                        <div class="col-md-6">
                            <div class="p-2 border bg-white rounded">
                                <span
                                    class="text-muted d-block small"><?php esc_html_e('Số lần quay tối đa:', 'wp-spin-wheel'); ?></span>
                                <strong
                                    class="sw-stat-max-spins text-dark"><?php echo esc_html($wheel_stats['max_spins']); ?></strong>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="p-2 border bg-white rounded">
                                <span
                                    class="text-muted d-block small"><?php esc_html_e('Lượt xem vòng quay:', 'wp-spin-wheel'); ?></span>
                                <strong
                                    class="sw-stat-views text-success"><?php echo esc_html(number_format_i18n($wheel_stats['views'])); ?></strong>
                        ...
                        <div class="col-md-6">
                            <div class="p-2 border bg-white rounded">
                                <span
                                    class="text-muted d-block small"><?php esc_html_e('Tổng số lượt đã quay:', 'wp-spin-wheel'); ?></span>
                                <strong
                                    class="sw-stat-total-spins text-info"><?php echo esc_html(number_format_i18n($wheel_stats['total_spins'])); ?></strong>
                        ...
                        <div class="col-md-6">
                            <div class="p-2 border bg-white rounded">
                                <span
                                    class="text-muted d-block small"><?php esc_html_e('Lượt quay hôm nay:', 'wp-spin-wheel'); ?></span>
                                <strong
                                    class="sw-stat-today-spins text-warning"><?php echo esc_html(number_format_i18n($wheel_stats['today_spins'])); ?></strong>
                                <small class="text-muted">(lượt)</small>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="p-2 border bg-white rounded">
                                <span
                                    class="text-muted d-block small"><?php esc_html_e('Tạo bởi:', 'wp-spin-wheel'); ?></span>
                                <strong
                                    class="sw-stat-creator text-dark"><?php echo esc_html($wheel_stats['creator']); ?></strong>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="p-2 border bg-white rounded">
                                <span
                                    class="text-muted d-block small"><?php esc_html_e('Ngày tạo:', 'wp-spin-wheel'); ?></span>
                                <strong
                                    class="sw-stat-created-at text-dark"><?php echo esc_html(($current_wid ? get_the_date('d/m/Y', $current_wid) : (! empty($wheel_stats['created_at']) ? explode(' ', $wheel_stats['created_at'])[0] : '')) ?: __('Chưa cập nhật', 'wp-spin-wheel')); ?></strong>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="modal-footer justify-content-center">
                <button type="button" class="btn btn-secondary px-4"
                    data-bs-dismiss="modal"><?php esc_html_e('Đóng lại', 'wp-spin-wheel'); ?></button>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="modal-content shadow-lg border-0">
            <div class="modal-header bg-light">
                <h5 class="modal-title font-weight-bold" id="modalRsLabel">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="22" viewBox="0 0 24 24" fill="none"
                        stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                        class="feather feather-book-open text-primary me-2">
                        <path d="M2 3h6a4 4 0 0 1 4 4v14a3 3 0 0 0-3-3H2z"></path>
                        <path d="M22 3h-6a4 4 0 0 0-4 4v14a3 3 0 0 1 3-3h7z"></path>
                    </svg>
                        ...
                        <thead class="table-light">
                            <tr>
                                ...
                                <th style="width: 130px;" class="text-end">
                                    <?php esc_html_e('Thời gian', 'wp-spin-wheel'); ?></th>
                            </tr>
                        </thead>
            ...
            <div class="modal-footer justify-content-between">
                <button type="button" class="btn btn-outline-danger btn-sm" id="btn-clear-session-results"
                    onclick="clearSessionResults();">
...
<div class="modal fade" id="modalDisplaystats" tabindex="-1" aria-labelledby="modalDisplaystatsLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg">
        <div class="modal-content shadow-lg border-0">
            <div class="modal-header bg-light">
                <h5 class="modal-title font-weight-bold" id="modalDisplaystatsLabel">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="22" viewBox="0 0 24 24" fill="none"
                        stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                        class="feather feather-clock text-primary me-2">
                        <circle cx="12" cy="12" r="10"></circle>
                        <polyline points="12 6 12 12 16 14"></polyline>
                    </svg>
            ...
            <div class="modal-body py-3">
                <div class="border rounded p-3 mb-3 bg-light">
                    <div class="fw-bold mb-2 text-dark d-flex align-items-center justify-content-between">
                        <span>👤 <span
                                id="sw-player-header-title"><?php echo esc_html($player_display . ($player_email ? " ($player_email)" : '')); ?></span>
                            <?php esc_html_e('đã quay:', 'wp-spin-wheel'); ?></span>
                        <button type="button" class="btn btn-sm btn-link text-decoration-none"
                            onclick="loadRealHistoryData();" title="<?php esc_attr_e('Tải lại', 'wp-spin-wheel'); ?>">🔄
                            <?php esc_html_e('Làm mới', 'wp-spin-wheel'); ?></button>
                    </div>

                    <ul class="list-group small" id="sw-history-list-group"
                        style="max-height: 350px; overflow-y: auto;">
                        <?php if (! empty($recent_history)) : ?>
                        <?php foreach ($recent_history as $h) : ?>
                        <li class="list-group-item d-flex justify-content-between align-items-center"
                            id="sw-hist-item-<?php echo esc_attr($h['id']); ?>">
                            <div>
                                <div class="fs-6 text-primary fw-bold">🎁 <?php echo esc_html($h['prize_title']); ?>
                                </div>
                            ...
                            <button class="btn btn-sm btn-outline-danger btn-delstat"
                                onclick="deleteStatItem(<?php echo esc_attr($h['id']); ?>, this);"
                                title="<?php esc_attr_e('Xóa bản ghi này', 'wp-spin-wheel'); ?>"
                    ...
                    <div id="sw-history-empty-msg" class="text-center py-4 text-muted"
                        style="<?php echo empty($recent_history) ? '' : 'display: none;'; ?>">
                        <span class="d-block mb-1" style="font-size: 24px;">📜</span>
            ...
            <div class="modal-footer justify-content-between flex-wrap gap-2">
                <button type="button" class="btn btn-danger btn-sm px-3" id="btn-clear-all-stats"
                ...
                <div class="d-flex gap-2">
                    <button type="button" class="btn btn-primary btn-sm px-3" id="btn-exportstats"
                        onclick="exportStats();">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none"
                            stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
        ...
        <div class="modal-content shadow-lg border-0">
            <div class="modal-header bg-light">
                <h5 class="modal-title font-weight-bold" id="modalEmbedLabel">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="22" viewBox="0 0 24 24" fill="none"
                        stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                        class="feather feather-code text-primary me-2">
                        <polyline points="16 18 22 12 16 6"></polyline>
                        <polyline points="8 6 2 12 8 18"></polyline>
                    </svg>
            ...
            <div class="modal-body py-3">
                ...
                <div>
                    ...
                    <div class="input-group">
                        <input type="text" class="form-control" id="sw-embed-iframe-val"
                            value="&lt;iframe src=&quot;<?php echo esc_url(get_permalink($current_wid)); ?>&quot; width=&quot;100%&quot; height=&quot;650&quot; frameborder=&quot;0&quot;&gt;&lt;/iframe&gt;"
                            readonly>
                        <button class="btn btn-outline-primary" type="button"
                            onclick="copyEmbedCode('sw-embed-iframe-val')"><?php esc_html_e('Sao chép', 'wp-spin-wheel'); ?></button>
                    </div>
                </div>
            </div>
...
(function() {
    ...
    function openSwModal(modalSelector) {
        ...
        // 3. Fallback CSS
        jQuery(modalEl).addClass('show').css('display', 'block').removeAttr('aria-hidden').attr('aria-modal',
            'true');
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        jQuery(document).on('click', '#sw-menu-dropdown-btn', function(e) {
            if ((window.bootstrap && window.bootstrap.Dropdown) || (window.jQuery && jQuery.fn &&
                    jQuery.fn.dropdown)) {
    ...
    jQuery.ajax({
        ...
        success: function(res) {
            if (res) {
                ...
                if (typeof res.views !== 'undefined') jQuery('.sw-stat-views').text(Number(res.views)
                    .toLocaleString('vi-VN'));
                if (typeof res.total_spins !== 'undefined') jQuery('.sw-stat-total-spins').text(Number(res
                    .total_spins).toLocaleString('vi-VN'));
                if (typeof res.today_spins !== 'undefined') jQuery('.sw-stat-today-spins').text(Number(res
                    .today_spins).toLocaleString('vi-VN'));
        ...
        success: function(res) {
            if (res && res.items && res.items.length > 0) {
                ...
                jQuery.each(res.items, function(idx, item) {
                    ...
                    html +=
                        '<li class="list-group-item d-flex justify-content-between align-items-center" id="sw-hist-item-' +
                        item.id + '">';
                    html += '  <div>';
                    html += '    <div class="fs-6 text-primary fw-bold">🎁 ' + escapeHtml(
                        prizeStr) + '</div>';
                    html += '    <div class="text-muted small">';
                    html += '      <span>👤 ' + escapeHtml(nameStr) + '</span> &bull; ';
                    html += '      <span>🎡 ' + escapeHtml(wheelTitle) + '</span> &bull; ';
                    html += '      <span class="sw-hist-time">⏱️ ' + escapeHtml(timeAgo) +
                        '</span>';
                    html += '    </div>';
                    html += '  </div>';
                    html +=
                        '  <button class="btn btn-sm btn-outline-danger btn-delstat" onclick="deleteStatItem(' +
                        item.id +
                        ', this);" title="Xóa bản ghi" style="border: none; padding: 2px 6px;">';
                    html +=
...
function exportStats() {
    var wid = getCurrentWheelId();
    var exportUrl = window.location.protocol + '//' + window.location.host +
        '/wp-admin/edit.php?post_type=spin_wheel&page=spin-wheel-history&action=export_csv&wheel_id=' + wid +
        '&_wpnonce=' + encodeURIComponent(wp_spin_wheel_params.nonce || '');
...
function updateSessionResultModal(prizeTitle) {
    ...
    var html = '<tr>' +
        ...
        '<td><span class="badge bg-primary px-2 py-1 text-wrap" style="font-size: 13px;">🎁 ' + escapeHtml(prizeTitle) +
        '</span></td>' +
