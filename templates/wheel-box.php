...
<div class="position-absolute top-0 end-0 mt-1 actions" id="actions">
    ...
    <button class="btn btn-sm" id="btn-share" data-bs-toggle="tooltip" data-bs-title="Tạo link chia sẻ"
        data-bs-placement="bottom" style="color: rgb(255, 255, 255);"><svg xmlns="http://www.w3.org/2000/svg" width="24"
...
<div class="lucky-box no-ads tpl-jib" id="lucky-box" data-box-id="<?php echo esc_attr($box_id); ?>" data-box-settings="<?php echo esc_attr(wp_json_encode($default_box_settings)); ?>" data-box-gifts="<?php echo esc_attr(wp_json_encode($default_gifts)); ?>">
    <div class="hqmm-meta mb-5" id="hqmm-meta">
        ...
        <div class="box-info mx-auto mb-3">
            <div class="card" style="background-color: rgb(220, 53, 69); color: rgb(255, 255, 255);">
                <div class="card-body">
                    <h1 class="wp-block-heading has-x-large-font-size" id="heading-title">HỘP QUÀ MAY MẮN ONLINE</h1>
                    <div class="badgex bg-secondaryx">Bạn còn <span class="fw-bold" id="conlai">3</span> lượt mở</div>
                </div>
            </div>
        </div>
    ...
    <div class="mt-5 text-center button-group" id="button-group">
        <button class="btn" id="btn-quatang" style="background-color: rgb(220, 53, 69); color: rgb(255, 255, 255);"><svg
                xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
        ...
        <button class="btn" id="btn-ketqua" style="background-color: rgb(220, 53, 69); color: rgb(255, 255, 255);"><svg
                xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                class="feather feather-gift">
                <polyline points="20 12 20 22 4 22 4 12"></polyline>
